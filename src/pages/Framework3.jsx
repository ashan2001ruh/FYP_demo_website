...
const ONBOARDING = [
  ...
  { title: 'That identity is anchored publicly', body: 'It is written to the ledger as an unprivileged entry: publicly resolvable, but with no authority to write anything itself.' },
...
const LIMITATIONS = [
  ...
  <><strong>Credentials are delivered out of band.</strong> The full issuer-to-holder exchange protocol is not implemented; the credential is written straight into the wallet by the provisioning pipeline, which is normal practice when the holder is software rather than a person.</>,
  <><strong>Revocation is not checked at runtime.</strong> The current prototype enforces credential validity through expiry timestamps only; it does not perform online revocation-registry checks. A revoked credential would continue to be accepted until its thirty-day validity window lapses.</>,
        ...
        <div className="container">
          ...
          <div className="grid-3" style={{ marginTop: 26 }}>
            <Reveal><div className="card" style={{ height: '100%' }}>
              ...
              <p>A four-node permissioned Hyperledger Indy network storing only public material: identifier documents, credential schemas and credential definitions. It never issues or holds an identity itself.</p>
            </div></Reveal>
            ...
            <Reveal>
              <div className="card" style={{ height: '100%' }}>
                ...
                <ul className="procon">
                  ...
                  <li>Revocation infrastructure is in place on the ledger; runtime revocation checking is outside the scope of the current implementation.</li>
